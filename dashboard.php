...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4 dashboard">
                <div class="card" style="background-color:#F18D33;">
                    <div class="media widget-ten">
                        <div class="media-left meida media-middle">
                            <span><i class="ti-calendar f-s-40"></i></span>
                        </div>
                        <div class="media-body media-text-right">
                           ...
                           <a href="/attendance/" target="_blank" class="btn btn-success">Mark Attendance</a>
                           <p style="color:white;"><br/>Attendance</p>
                        </div>
                    </div>
                </div>
            </div>
