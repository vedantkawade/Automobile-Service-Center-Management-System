			...
			<form method="post" id="studentForm">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="Joining Year" class="control-label">Joining Year</label>				
						...
						<div class="form-group"
							<label for="Employee Number" class="control-label">Employee No</label>
							<input type="number" class="form-control" id="rollNo" name="rollNo" placeholder="Employee Number" required>			
						</div>
	...
	<div id="studentDetails" class="modal fade">
    	<div class="modal-dialog">    		
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title"><i class="fa fa-plus"></i> Employee Details</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="name" class="control-label">Name:</label>
					...
					<div class="form-group">
						<label for="phone" class="control-label">Employee No:</label>							
