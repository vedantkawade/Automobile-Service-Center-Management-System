...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
           ...
           <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
            <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown08" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-cogs"></i> Service</a>
            <div class="dropdown-menu" aria-labelledby="dropdown08">
              <a class="dropdown-item" href="add-product.php">Add Service</a>
              <a class="dropdown-item" href="product.php">Manage Service</a>
            </div>
          </li>
          <?php }?>
          <li class="nav-item dropdown">
